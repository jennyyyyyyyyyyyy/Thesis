...
public final class ProgressDialogBinding implements ViewBinding {
  ...
  private ProgressDialogBinding(@NonNull ConstraintLayout rootView,
      @NonNull ProgressBar progressBar, @NonNull TextView progressMessage) {
  ...
  public static ProgressDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProgressDialogBinding((ConstraintLayout) rootView, progressBar, progressMessage);
    }
