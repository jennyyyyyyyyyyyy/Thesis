...
public final class ActivityFslToTextBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final Button buttonUpdateModel;
  ...
  private ActivityFslToTextBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnReply,
      @NonNull Button btnRestart, @NonNull Button btnStart, @NonNull Button buttonUpdateModel,
  ...
  @NonNull
  public static ActivityFslToTextBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFslToTextBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_fsl_to_text, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFslToTextBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.button_update_model;
      Button buttonUpdateModel = ViewBindings.findChildViewById(rootView, id);
      if (buttonUpdateModel == null) {
        break missingId;
      }
      ...
      return new ActivityFslToTextBinding((ConstraintLayout) rootView, btnReply, btnRestart,
          btnStart, buttonUpdateModel, cameraImage, binding_customToolbar, fragmentContainer,
          linearLayout2, topBox);
    }
