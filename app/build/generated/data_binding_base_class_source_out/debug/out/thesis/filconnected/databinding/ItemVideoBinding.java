...
public final class ItemVideoBinding implements ViewBinding {
  ...
  private ItemVideoBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnDelete,
  ...
  public static ItemVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemVideoBinding((LinearLayout) rootView, btnDelete, tvVideoName);
    }
